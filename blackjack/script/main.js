...
function showCard() {
    if (begain == 0) {} else {
        ...
        alert('(Computer：' + count[1].sum + ') vs (' + 'Your' + count[2].sum + ')');
...
function init() {
    ...
    document.getElementById('p_1').innerHTML = '<p style="color: white">Computer</p>';
    document.getElementById('p_2').innerHTML = '<p style="color: white">Your</p>';
...
var exit = document.getElementById("exit");
    exit.onclick = function() {
        if (confirm("Are you sure you want to quit the game? If it is launched, please close the app directly")) {
            window.close();
        }
    }
